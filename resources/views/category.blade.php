      ...
      <div class="row mt-3">
        ...
        <div class="col-12 col-md-8">
          <div class="row row-cols-2 row-cols-md-2 row-cols-lg-3 my-2">
            ...
            <div class="col mb-3 mb-lg-0 px-1 px-md-2">
              <div class="line-test position-relative bg-white border-lg-0 border product-place text-center h-100 w-100 py-3 px-2">
                <img class="liked-icon position-absolute" src="img/favourite.svg" alt="">
                <img class="product-pic my-md-5 my-3" src="css/img/Products/tablet.png" alt="">
