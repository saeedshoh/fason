    ...
    <form action="{{ route('ft-store.store') }}" enctype="multipart/form-data" method="POST">
      ...
      <div class="row mt-3">
        <div class="col-md-3 px-0 px-md-2 position-relative">
          <div class="text-center d-none d-md-block">
            ...
            <div class="edit-store-logo position-absolute w-100">
              <button type="button" class="btn btn-edit rounded-pill">
                <img src="/storage/theme/icons/camera.svg" height="14px" class="mw-100 align-text-top" alt="">Изменить
              </button>
            </div>
          </div>
        </div>
        <div class="col-md-9 px-0 px-md-2 position-relative">
          ...
          <div class="edit-name position-absolute">
            <div class="d-none d-md-block">
              <button type="button" class="btn btn-edit rounded-pill">
                <img src="/storage/theme/icons/change.svg" height="14px" class="mw-100 align-text-top" alt="">Изменить
              </button>
              <h3 class="h3 d-inline-block align-top">Olim H.</h3>
            </div>
          </div>
      ...
      <div class="row mt-5">
        <div class="col-12 col-lg-6">
          <div class="form-group row">
            <label for="aboutStore" class="col-sm-4 col-form-label text-muted font-weight-bold">О магазине:</label>
            <div class="col-sm-8">
              <input type="email" class="form-control" id="aboutStore">
            </div>
          </div>
          <div class="form-group row">
            <label for="Adress" class="col-sm-4 col-form-label text-secondary font-weight-bold">Aдресс:</label>
            <div class="col-sm-8">
