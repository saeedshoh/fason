    ...
    <div class="container">
        ...
        @elseif($store->is_active == 0)
            <div class="col-12  px-0 px-md-2">
                ...
                <h4 class="alert-heading">Внимание!</h4>
                <p>Ваш магазин отключен. Для подробной информации свяжитесь с модератором: <br> Телефон для справки <a href="tel:+992000029641"class="alert-link">000 02 9641 </a></p>
                </div>
            </div>
        @endif
      <script>
