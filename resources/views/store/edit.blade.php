  ...
  <section class="content profile mt-0 mt-md-5">
        ...
        <div class="col-12 col-lg-3">
          <div class="text-center">
            <div class="position-relative d-inline-block">
              <img src="css/img/itpark.png" class="img-fluid" alt="">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 col-lg-3 my-3 my-lg-0">
            <a class="btn btn-danger w-100" href="#"><img class="mr-1" src="img/store.svg" alt="">Мои товары</a>
          </div>
          <div class="col-md-6 col-lg-3 my-3 my-lg-0">
            <a class="btn btn-danger w-100" href="#"><img class="mr-1" src="img/orders.svg" alt="">История продаж</a>
          </div>
          <div class="col-md-6 col-lg-3 my-3 my-lg-0">
            <a class="btn btn-danger w-100" href="#"><img class="mr-1" src="img/add.svg" alt="">Добавить товар</a>
          </div>
          <div class="col-md-6 col-lg-3 my-3 my-lg-0">
            <a class="btn btn-danger w-100" href="#"><img class="mr-1" src="img/saved.svg" alt="">Сохраненные</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="all-product container mt-5">
      <div class="row row-cols-2 row-cols-md-3 row-cols-lg-5 my-3">
        ...
        <div class="col d-flex mb-3 mb-lg-0 px-1 px-md-3">
          <div class="order-success position-relative bg-white border text-center py-3 px-2">
            <img class="img-fluid my-md-5 my-3" src="css/img/Products/tablet.png" alt="">
            <h4 class="product-name shop-subject">Samsung g12312 45D </h4>
            <p class="about-product mb-2">
              Lorem Ipsum is simply dummy text.
        ...
        <div class="col d-flex mb-3 mb-lg-0 px-1 px-md-3">
          <div class="order-preparing position-relative bg-white border text-center py-3 px-2">
            <img class="img-fluid my-md-5 my-3" src="css/img/Products/tablet.png" alt="">
            <h4 class="product-name shop-subject">Samsung g12312 45D </h4>
            <p class="about-product mb-2">
              Lorem Ipsum is simply dummy text.
        ...
        <div class="col d-flex mb-3 mb-lg-0 px-1 px-md-3">
          <div class="order-preparing position-relative bg-white border-lg-0 border text-center py-3 px-2">
            <img class="img-fluid my-md-5 my-3" src="css/img/Products/tablet.png" alt="">
            <h4 class="product-name shop-subject">Samsung g12312 45D </h4>
            <p class="about-product mb-2">
              Lorem Ipsum is simply dummy text.
