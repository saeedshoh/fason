    ...
    <form action="{{ route('ft-store.update', $store->id) }}" novalidate enctype="multipart/form-data" method="POST" id="update-store">
      ...
      <div class="row mt-sm-3">
        ...
        <div class="col-md-9 px-0 px-md-2 position-relative">
          <label for="cover">
            <img src="/storage/{{ $store->cover ?? 'theme/banner_store.svg' }}" class="w-100 rounded store-image object-cover" id="cover-poster-mobile" height="216">
          </label>
          <div class="change-banner position-absolute">
           ...
           <div class="d-block d-md-none mb-3 mt-3 px-3">
              <span class="text-muted">Фотография баннера <span class="badge badge-danger"> размером 840х215</span></span>
            </div>
