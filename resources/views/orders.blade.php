...
@section('content')
  <section>
    <div class="container mt-3 mb-5 px-md-0 order-scroll">
       <!--tabs-->
        <div class="px-0 bg-white rounded order-tab p-md-3">
            <div class="pb-5 pb-lg-0">
                <ul class="nav nav-pills justify-content-between" id="myTab" role="tablist">
                    @if($sales)
                            ...
                            <li class="nav-item {{ $is_store ? 'w-50' : 'w-100' }} text-center pr-1" role="presentation">
                                <a class="nav-link orders px-1  py-0 {{ request()->has('orderPage') ? 'active' : '' }} " id="buy-tab" data-toggle="tab" href="#buy" role="tab" aria-controls="buy" aria-selected="false">Покупка</a>
                            </li>
                            @if ($is_store)
                                <li class="pl-1 text-center nav-item w-50" role="presentation">
                                    <a class="nav-link orders px-1 py-0   {{  request()->has('salePage') || count(request()->all()) == 0 ? 'active' : '' }} " id="sell-tab" data-toggle="tab" href="#sell" role="tab" aria-controls="sell" aria-selected="true">Продажа</a>
                                </li>
                            @endif
                    @else

                        <li class="nav-item {{ $is_store ? 'w-50' : 'w-100' }} text-center pr-1" role="presentation">
                            <a class="nav-link orders {{ request()->has('orderPage')  || count($sales) == 0 ? 'active' : '' }} px-1 py-0" id="buy-tab" data-toggle="tab" href="#buy" role="tab" aria-controls="buy" aria-selected="true">Покупка</a>
                        </li>
                        @if ($is_store)
                            <li class="pl-1 text-center nav-item w-50" role="presentation">
                                <a class="nav-link orders px-1 py-0 {{ request()->has('salePage') ? 'active' : '' }}" id="sell-tab" data-toggle="tab" href="#sell" role="tab" aria-controls="sell" aria-selected="false">Продажа</a>
                            </li>
                        @endif
                    @endif
                </ul>
                <div class="tab-content" id="myTabContent">
                    <!--buy tabs-->
                    <div class="tab-pane fade @if($sales) @if(request()->has('orderPage')) show active @endif  @else show active @endif" id="buy" data-type="2" role="tabpanel" aria-labelledby="buy-tab">

                        <!--success order-->
                        @forelse ($orders as $order)
                        <div class="mt-3 text-right d-block d-lg-none">
                        ...
                        <div class="border borderRounded my-3 @if ($order->order_status_id == 3)border-success @elseif($order->order_status_id == 1)border-warning @elseif($order->order_status_id == 4)border-primary @elseif($order->order_status_id == 5)border-secondary @else()border-danger @endif">
                            ...
                            <div class="mx-0 my-2 row align-items-start position-relative">
                                <div class="col-12 col-lg-6 px-2 px-sm-3 border-left border_left @if ($order->order_status_id == 3)border-success @elseif($order->order_status_id == 1)border-warning @elseif($order->order_status_id == 4)border-primary @elseif($order->order_status_id == 5)border-secondary @else()border-danger @endif">
                                    ...
                                    <div class="d-flex flex-column align-self-center w-100">
                                        ...
                                        <div>
                                            <div class="mb-2 d-lg-none d-flex flex-column">
                                                <small class="mr-2 text-secondary w-100">
                                ...
                                <div class="col-2 d-none d-lg-block">
                                    ...
                                    <h5 class="flex-wrap font-weight-bold d-flex align-items-center">
                    ...
                    @if ($is_store)
                        <div class="tab-pane fade @if($sales) @if(request()->has('salePage') || count(request()->all()) == 0) show active  @endif @endif" id="sell" data-type="1" role="tabpanel" aria-labelledby="sell-tab">
