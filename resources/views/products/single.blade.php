          ...
          <div class="my-3 text-center d-flex justify-content-around product-buttons">
            ...
            @if(Auth::check())
                ...
                <form action="{{ route('products.destroy', $product) }}" method="POST">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="rounded-11 btn btn-outline-secondary ml-md-2 my-1 delete-product">
                ...
                @else
                    <form action="{{ route('ft_product.cancelDestroy', $product->slug) }}" method="POST">
                        @csrf
                        @method('POST')
                        <button type="button" class="rounded-11 btn btn-outline-secondary  ml-md-2 my-1restore-product">
                            <svg xmlns="http://www.w3.org/2000/svg" height="15px" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 507.289 507.289" style="enable-background:new 0 0 507.289 507.289;" xml:space="preserve">
                                <g>
                                    <g>
                                        <g>
            ...
            <div class="my-3 text-center d-flex justify-content-end w-100">
              ...
              @if(Auth::check())
                ...
                <form action="{{ route('ft_product.cancelDestroy', $product->slug) }}" method="POST">
                  @csrf
                  @method('POST')
                  <button type="button" class="rounded-11 btn btn-outline-secondary  ml-md-2 my-1 px-2 restore-product">
                      <svg xmlns="http://www.w3.org/2000/svg" height="15px" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 507.289 507.289" style="enable-background:new 0 0 507.289 507.289;" xml:space="preserve">
                          <g>
                              <g>
                                  <g>
