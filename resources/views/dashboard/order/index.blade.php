                    ...
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <h1 class="header-title">
                                Все заказы <span class="badge badge-pill badge-soft-secondary">{{ $orders->total() }}</span>
                            </h1>
                                        ...
                                        <div class="list-group list-group-flush mt-n4 mb-4">
                                            <div class="list-group-item">
                                                <div class="row">
                                                    ...
                                                    <div class="col-8">
                                                        <!-- Select -->
                                                        <select class="custom-select custom-select-sm chosen-select" name="user_id" data-choices>
