...
@section('title', 'Отклоненые товары')
            ...
            <div class="row align-items-center">
              <div class="col">
                ...
                <h1 class="header-title text-truncate">
                    Отклонено <span class="badge badge-pill badge-light">{{ $products->total() }}</span>
                </h1>
                ...
                <ul class="nav nav-tabs nav-overflow header-tabs">
                  ...
                  <li class="nav-item">
                    <a href="{{ route('products.canceled') }}" class="nav-link active">
                      Отклонённые <span class="badge badge-pill badge-light">{{ $products->total() }}</span>
                    </a>
                  </li>
                  <li class="nav-item">
