...
@section('title', 'Товары на проверке')
            ...
            <div class="row align-items-center">
              <div class="col">
                ...
                <h1 class="header-title text-truncate">
                    На проверке <span class="badge badge-pill badge-soft-warning">{{ $products->total() }}</span>
                </h1>
                  ...
                  <div class="col">
                    ...
                    <form>
                      <div class="input-group input-group-flush">
                        ...
                        <input class="form-control" type="text" placeholder="Поиск" data-item="products/statuses/onCheck" id="search" value="{{ request()->search }}">
                      </div>
                    </form>
