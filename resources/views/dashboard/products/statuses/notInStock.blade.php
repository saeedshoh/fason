...
@section('title', 'Товары которые нет в наличии')
      ...
      <div class="col-12">
            ...
            <div class="row align-items-center">
              <div class="col">
                ...
                <h1 class="header-title text-truncate">
                    Нет в наличии <span class="badge badge-pill badge-soft-primary">{{ $products->total() }}</span>
                </h1>
        ...
        <div class="tab-content">
          <div class="tab-pane fade show active" id="contactsListPane" role="tabpanel" aria-labelledby="contactsListTab">
            ...
            <!-- Card -->
            <div class="card" data-list='{"valueNames": ["item-order", "item-name", "item-total", "item-category", "item-date", "item-quantity", "item-company", "item-status"]}' id="contactsList">
                        ...
                        <div class="col">
                            ...
                            <form>
                                <div class="input-group input-group-flush">
                                    ...
                                    <input class="form-control" type="search" placeholder="Поиск" data-item="products/statuses/notInStock" id="search" value="{{ request()->search }}">
                                </div>
                            </form>
