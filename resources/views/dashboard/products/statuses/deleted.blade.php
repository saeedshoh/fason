...
@section('title', 'Удаленные товары')
                ...
                <div class="card-header">
                    ...
                    <div class="col">
                        ...
                        <div class="input-group input-group-flush">
                            ...
                            <input class="form-control" type="search" placeholder="Поиск" data-item="products/statuses/deleted" id="search" value="{{ request()->search }}">
                        </div>
                        </form>
