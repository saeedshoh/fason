                ...
                <div class="card-header">
                    ...
                    <div class="col">
                        ...
                        <div class="input-group input-group-flush">
                            ...
                            <input class="form-control" type="text" placeholder="Поиск" data-item="products/statuses/hidden" id="search" value="{{ request()->search }}">
                        </div>
                        </form>
