                        ...
                        <form action="{{ route('products.store') }}" method="POST" class="needs-validation mb-4" enctype="multipart/form-data" accept-charset="utf-8" novalidate id="create_product">
                            ...
                            <div class="form-row">
                                <div class="col-12 col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="price" placeholder="Введите название категори" name="price" value="{{ old('price') }}" required="">
                                    <div class="valid-feedback">
                                    Looks good!
                                    </div>
                                </div>
                                <div class="col-12 col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="quantity" placeholder="Введите название категори" name="quantity" value="{{ old('quantity') }}" required="">
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
