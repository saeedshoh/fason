            ...
            <div class="row align-items-center">
              <div class="col">
                ...
                <h1 class="header-title">
                  Все заказы <span class="badge badge-pill badge-soft-secondary">@if($user->orders){{ $user->orders->count()}}@else 0 @endif</span>
                </h1>

              </div>
              <div class="col-auto">
                <!-- Buttons -->
                <a href="{{ route('clients.index')}}" class="btn btn-primary ml-2">
                    Все клиенты
                </a>
              </div>
