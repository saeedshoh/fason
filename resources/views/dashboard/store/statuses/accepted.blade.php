                    ...
                    <div class="col">
                        ...
                        <ul class="nav nav-tabs nav-overflow header-tabs">
                            ...
                            <a href="{{ route('stores.accepted') }}" class="nav-link active">
                                Активные <span class="badge badge-pill badge-soft-success">{{ $stores->total() }}</span>
                            </a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="col">
                            ...
                            <form>
                                <div class="input-group input-group-flush">
                                    ...
                                    <input class="form-control" type="text" placeholder="Поиск" data-item="stores/accepted" id="search" value="{{ request()->search }}" autocomplete="off">
                                </div>
                            </form>
                        </div>
                    </div> <!-- / .row -->
                </div>
                <div id="stores_accepted">
