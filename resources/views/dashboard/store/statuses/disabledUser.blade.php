                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="nav nav-tabs nav-overflow header-tabs">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('stores.disabledUser') }}" class="nav-link active">
                                    Отключенные клиентом <span class="badge badge-pill badge-soft-info">{{ $stores->total() }}</span>
                                </a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="col">
                            ...
                            <form>
                                <div class="input-group input-group-flush">
                                    ...
                                    <input class="form-control" type="text" placeholder="Поиск" data-item="stores/disabledUser" id="search" value="{{ request()->search }}" autocomplete="off">
                                </div>
                            </form>
                        </div>
                    </div> <!-- / .row -->
                </div>
                <div id="stores_disabledUser">
                    <div class="table-responsive">
                        <table class="table table-sm table-hover table-nowrap card-table">
                            ...
                            <tbody class="list font-size-base">
                                ...
                                <tr class="@if($store->is_moderation) table-warning @elseif($store->is_active == 2) table-info @else table-success @endif">
                                    <td class="item-order">
