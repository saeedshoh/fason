        ...
        <div class="header mt-md-5">
            <div class="header-body">
                ...
                <p class="header-subtitle">
                    Для зоздания категории заполните поля
                </p>
            </div>
        </div>
    @if($errors->any())
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="custom-file">
                                ...
                                <input value="{{old('icon')}}" type="file" name="icon" id="icon" class="custom-file-input @error('icon')is-invalid @enderror" lang="en" required>
                            </div>
                            @isset($icon)
