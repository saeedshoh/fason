                        ...
                        <form action="{{ route('cities.update', $city) }}" method="POST" class="needs-validation mb-4" enctype="multipart/form-data" accept-charset="utf-8" novalidates>
                            ...
                            <div class="form-row">
                                <div class="col-12 col-md-12 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Введите название категори" name="name" value="{{ old('name') ?? $city->name }}" required="">
                                    @error('name')
