    ...
    if ($(document).height() - $(this).height() == $(this).scrollTop()) {
      if ($("#favorite_scroll")[0]) {
        if (step_favorite != 0) {
          ...
          $.get("favorite?page=" + step_favorite, function (data, status) {
            $(".loading_hide_favorite:last").addClass("d-none");
            step_favorite++;
            var favorite_products = $.parseHTML(data);

            if ($(favorite_products).find("div.empty-favorite").text() != "Извените ничего не найдено") {
              $(".active-product").append($(favorite_products).find(".active-product").html());
            } else {
              step_favorite = 0;
            }
          });
...
$(document).ready(function () {
  ...
  function fetchPosts() {
    ...
    if (page !== null && page !== "" && !page.substring(0, 5).includes("null&")) {
      $("#scroll-spinner").removeClass("d-none"); // clearTimeout($.data(this, 'scrollCheck'))
      // $.data(
      //     this,
      //     'scrollCheck',
...
$("body").on("change", "#cat_child_value", function () {
  var id = $("#cat_child_value option:selected").val();
  $.ajax({
    url: "/getSubcategories",
    data: {
      category: id
...
$("body").on("change", "#grandchildren", function () {
  var id = $("#grandchildren option:selected").val();
  $.ajax({
    url: "/getAttributes",
    data: {
      category_id: id
  ...
  $.ajax({
    ...
    success: function success(data) {
      if (!_this.is(":checked")) {
        ...
        _this.closest("div").find(".Selects").remove();
...
function avatar(input) {
  if (input.files && input.files[0]) {
    ...
    reader.onload = function (e) {
      if (input.files && input.files[0]) {
        new compressorjs__WEBPACK_IMPORTED_MODULE_2___default.a(input.files[0], {
          quality: 0.8,
          maxWidth: 700,
          maxHeight: 700,
          minWidth: 700,
...
$(document).on('click', '.add-product-btn', function () {
  if ($('#name').val() != '' && $('#description').val() != '' && $('#quantity').val() != '' && $('select[name="category_id"]').val() != '' && $('#price').val() != '' && ($('#main-poster').attr('src').includes('data:image') || $('#main-poster').attr('src') != '/storage/theme/icons/add_product_plus.svg')) {
    var callback = function callback() {
      ...
      $.ajax({
        ...
        success: function success(data) {
          ...
          $('.content .container:eq(0)').addClass('bg-white').empty().html("<div class=\"mt-lg-5 py-lg-5 py-3 text-center\"><img class=\"mb-5\" src=\"/storage/theme/thanks.svg\" width=\"180px\" alt=\"\"><div class=\"mb-3 pb-lg-0\"><h5>\u0422\u043E\u0432\u0430\u0440 \u0443\u0441\u043F\u0435\u0448\u043D\u043E ".concat(_check_page == 'true' ? 'обновлен' : 'добавлен', " \u0438 \u043F\u0440\u043E\u0445\u043E\u0434\u0438\u0442 \u043C\u043E\u0434\u0435\u0440\u0430\u0446\u0438\u044E </h5><a class=\"rounded-11 btn btn-outline-danger mt-4\" href=\"/store/").concat(store_name, "/show\">\u0412\u0435\u0440\u043D\u0443\u0442\u044C\u0441\u044F \u0432 \u043C\u0430\u0433\u0430\u0437\u0438\u043D</a></div></div>"));
        },
        error: function error(xhr, status, _error) {
          console.log(status);
        },
    ...
    var _check_page = document.getElementById('db-preview-image').dataset.edit;
...
$('body').on('keyup', '#price', Object(lodash__WEBPACK_IMPORTED_MODULE_1__["throttle"])(function () {
  ...
  if ($('select[name="category_id"]').val() != '' && $('#price').val() != '' && $(this).val() != '0') {
    ...
    $.ajax({
      ...
      success: function success(total) {
        $('.append-div').empty().append("\n                <div class=\"d-flex align-items-center w-100 justify-content-between mb-2\"><span>\u041A\u043E\u043C\u0438\u0441\u0441\u0438\u044F fason.tj:</span><span class=\"font-weight-bold\">".concat(total - price, "</span></div>\n                <div class=\"d-flex align-items-center w-100 justify-content-between\"><span>\u0418\u0442\u043E\u0433\u043E:</span><span class=\"font-weight-bold\">").concat(total, "</span></div>\n                "));
        console.log(price);
      },
      error: function error(xhr, status, _error2) {
        console.log(status);
...
$(document).on('click', '#storeSubmit', function (e) {
  ...
  if ($('input[name="name"]').val() != '' && $('input[name="address').val() != '' && $('textarea[name="description"]').val() != '' && $('input[name="city_id"]').val() != '') {
    ...
    var avatar = $('#avatar-poster').attr('src');
    var cover = $('#cover-poster-mobile').attr('src');
    formData.append('_token', $('meta[name=csrf-token]').attr('content'));
    formData.append('_method', $('input[name=_method]').val());
    formData.append('name', name);
    formData.append('address', address);
    ...
    $.ajax({
      ...
      success: function success() {
        ...
        $('.content .container:eq(0)').addClass('bg-white').empty().html("<div class=\"mt-lg-5 py-lg-5 py-3 text-center\">\n                            <img class=\"mb-5\" src=\"/storage/theme/thanks.svg\" width=\"180px\" alt=\"\">\n                            <div class=\"mb-3 pb-lg-0\">\n                                <h5>\u0422\u043E\u0432\u0430\u0440 \u0443\u0441\u043F\u0435\u0448\u043D\u043E ".concat(check_page == 'true' ? 'обновлен' : 'добавлен', " \u0438 \u043F\u0440\u043E\u0445\u043E\u0434\u0438\u0442 \u043C\u043E\u0434\u0435\u0440\u0430\u0446\u0438\u044E </h5>\n                                <a class=\"rounded-11 btn btn-outline-danger mt-4\" href=\"/\">\u041D\u0430 \u0433\u043B\u0430\u0432\u043D\u0443\u044E</a>\n                            </div>\n                        </div>"));
      },
...
$(document).on('click', '#storeEditSubmit', function (e) {
  ...
  if ($('input[name="name"]').val() != '' && $('input[name="address').val() != '' && $('textarea[name="description"]').val() != '' && $('input[name="city_id"]').val() != '') {
    ...
    formData.append('cover', cover);
    $.ajax({
      url: (dashboard ? "/dashboard" : "") + "/store/update/".concat(id),
      type: 'POST',
      headers: {
        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
      },
      ...
      success: function success(data) {
        if (data.where == 'website') {
          window.location.href = "/moderation/".concat(data.parameter);
        } else {
...
module.exports = __webpack_require__(/*! C:\OpenServer\domains\fason.tj\resources\js\main.js */"./resources/js/main.js");
